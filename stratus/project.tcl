...
define_hls_config GaussianFilter PIPELINING -DII=9
define_hls_config GaussianFilter UNROLLING
define_hls_config GaussianFilter UNROLLANDPIPELINE -DII=9
...
### 5.4 The Verilog simulation for HLS config "PIPELINING"
define_sim_config V_PIPELINING "GaussianFilter RTL_V PIPELINING" -argv "$IN_FILE_NAME $OUT_FILE_NAME"

### 5.5 The Verilog simulation for HLS config "UNROLLING"
define_sim_config V_UNROLLING "GaussianFilter RTL_V UNROLLING" -argv "$IN_FILE_NAME $OUT_FILE_NAME"

### 5.6 The Verilog simulation for HLS config combine "UNROLLING" and "PIPELINE"
define_sim_config V_UNROLLANDPIPELINE "GaussianFilter RTL_V UNROLLANDPIPELINE" -argv "$IN_FILE_NAME $OUT_FILE_NAME"